...
class KeyPadComponent extends Component {
   render() {
    return (
        ...
        <button className='highlight' name="*" onClick={e => this.props.onClick(e.target.name)}>x</button>
        ...
        <button className='highlight' id="result" name="=" onClick={e => this.props.onClick(e.target.name)}>=</button>
...
export { KeyPadComponent as default };
